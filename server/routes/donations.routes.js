...
import { createDonation, deleteDonation, getDonationById, getMyDonations, updateDonationStatus ,getAllDonations} from '../controllers/donation.controller.js';
...
router.route('/getall').post(getAllDonations)
